"""
Django settings for Image_cloud project.
...
SECRET_KEY = 'django-insecure-t=t(y!96do^q9q4n=r@k5^f5-+n0p+-4%dv59dg4myb45&)f+u'
...
WSGI_APPLICATION = 'Image_cloud.wsgi.application'
